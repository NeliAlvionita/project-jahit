@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url(assets/images/jahit1.jpg);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Custom Outfit Pilihanmu Di Sini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Custom outfit disini terjamin kualitasnya dan tentunya hasilnya juga tidak mengecewakan. </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas bahannya terjamin karena semuanya disini memakai bahan kualitas super.</p>
        </div>
        </div>
